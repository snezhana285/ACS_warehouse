...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlТоварНаСкладе_КоличествоLabel" runat="server" Text="Товаров на складе (количество)" EnableViewState="False">
</asp:Label>
<ac:DecimalTextBox CssClass="descTxt" ReadOnly="true" ID="ctrlТоварНаСкладе_Количество" runat="server">
</ac:DecimalTextBox>


</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlПоступления_КоличествоLabel" runat="server" Text="Поступления (количество)" EnableViewState="False">
</asp:Label>
<ac:DecimalTextBox CssClass="descTxt" ReadOnly="true" ID="ctrlПоступления_Количество" runat="server">
</ac:DecimalTextBox>
